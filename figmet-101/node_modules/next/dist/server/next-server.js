   ...
   */ async handleApiRequest(req, res, pathname, query) {
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            opts.supportsDynamicHTML = !isSSG && !isLikeServerless && !query.amp && !this.minimalMode && typeof ((ref45 = components.Document) === null || ref45 === void 0 ? void 0 : ref45.getInitialProps) !== 'function';
        }
        ...
        resolvedUrlPathname = (0, _normalizeLocalePath).normalizeLocalePath((0, _normalizeTrailingSlash).removePathTrailingSlash(resolvedUrlPathname), (ref44 = this.nextConfig.i18n) === null || ref44 === void 0 ? void 0 : ref44.locales).pathname;
